...
namespace Quibble.UI.Identity.Areas.Identity.Pages.Account.Manage
{
    public class ExternalLoginsModel : PageModel
    {
        ...
        public IList<UserLoginInfo> CurrentLogins { get; private set; } = new List<UserLoginInfo>();

        public IList<AuthenticationScheme> OtherLogins { get; private set; } = new List<AuthenticationScheme>();
