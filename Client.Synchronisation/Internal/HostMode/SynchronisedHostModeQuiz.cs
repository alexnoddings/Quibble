...
{
    internal sealed class SynchronisedHostModeQuiz : SynchronisedEntity, ISynchronisedHostModeQuiz
    {
        ...
        public SynchronisedHostModeQuiz(ILogger<SynchronisedEntity> logger, HubConnection hubConnection, IQuiz quiz)
